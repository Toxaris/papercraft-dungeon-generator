...
// grid
picture
    .line(0, -squareSize, 0, squareSize)
    .stroke(gridStroke);
picture
    .line(-squareSize, 0, squareSize, 0)
    .stroke(gridStroke);
...
// border of 2x2 base
picture
    .rect(2 * squareSize - borderStroke.width, 2 * squareSize - borderStroke.width)
    .move(-squareSize + borderStroke.width / 2, -squareSize + borderStroke.width / 2)
    .fill('none')
    .stroke(borderStroke);
